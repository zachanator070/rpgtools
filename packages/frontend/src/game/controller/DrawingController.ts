...
export default abstract class DrawingController<T extends Stroke | FogStroke> implements GameController{
    ...
    abstract set  drawCanvas(drawCanvas: HTMLCanvasElement);

    abstract get drawTexture(): Texture;

    abstract set drawTexture(drawTexture: Texture);

    abstract get drawMaterial(): MeshBasicMaterial;

    abstract set drawMaterial(drawMaterial: MeshBasicMaterial);

    abstract get drawMesh(): Mesh<BufferGeometry, MeshBasicMaterial>;

    abstract set drawMesh(drawMesh: Mesh<BufferGeometry, MeshBasicMaterial>);

    abstract get brushOptions(): BrushOptions;

    abstract get brushMesh(): Mesh<BufferGeometry, MeshBasicMaterial>;

    abstract set brushMesh(brushMesh: Mesh<BufferGeometry, MeshBasicMaterial>);

    abstract get brushMaterial(): MeshBasicMaterial;
    ...
    abstract set pathBeingDrawn(pathBeingDrawn: PathNode[]);

    abstract get strokeBeingDrawnId(): string;

    abstract set strokeBeingDrawnId(strokeBeingDrawnId: string);

    abstract get meshY(): number;
}