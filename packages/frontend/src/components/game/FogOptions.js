	...
	return <>
		<div className={'margin-md'}>
			...
			<Select value={brushType} style={{ width: 120 }} onChange={async (value) => {
				...
				<Select.Option value={BRUSH_FOG} default>Fog</Select.Option>
		...
		<div className={'margin-md'}>
			...
			<ToolTip><p>Change the opacity of fog for yourself only. Has no effect on fog for other players.</p></ToolTip>
			<Slider
				min={0}
				max={100}
				onChange={async (value) => {
