...
export class MoveControls {
	...
	moveModel = () => {
		...
		const newHypotenuseLength = this.selectControls.intersectionPoint.y/Math.sin(theta);
		...
		this.selectControls.selectedMeshedModel.mesh.position.copy(newModelPosition);
