...
export default class GameModel extends PermissionControlledModel {
    ...
    declare setCharacters: HasManySetAssociationsMixin<CharacterModel, string>;
    declare getStrokes: HasManyGetAssociationsMixin<StrokeModel>;
    declare setStrokes: HasManySetAssociationsMixin<StrokeModel, string>;
    declare getFog: HasManyGetAssociationsMixin<FogStrokeModel>;
    declare setFog: HasManySetAssociationsMixin<FogStrokeModel, string>;
    declare getMessages: HasManyGetAssociationsMixin<MessageModel>;
    declare setMessages: HasManySetAssociationsMixin<MessageModel, string>;
    declare getModels: HasManyGetAssociationsMixin<InGameModelModel>;
    declare setModels: HasManySetAssociationsMixin<InGameModelModel, string>;
