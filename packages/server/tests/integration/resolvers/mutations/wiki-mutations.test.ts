import fs from "fs";
import {EVENT_WIKI, PLACE} from "@rpgtools/common/src/type-constants.js";
...
import {CREATE_WIKI, DELETE_WIKI, UPDATE_EVENT, UPDATE_PLACE, UPDATE_WIKI} from "@rpgtools/common/src/gql-mutations.js";
