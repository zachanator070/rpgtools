...
export const WIKI_FOLDER_PERMISSIONS = [FOLDER_READ, FOLDER_RW, FOLDER_ADMIN, FOLDER_READ_ALL_CHILDREN, FOLDER_RW_ALL_CHILDREN, FOLDER_READ_ALL_PAGES, FOLDER_RW_ALL_PAGES];
